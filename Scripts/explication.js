...
document.querySelector("#aExplicacion").addEventListener("click", function() {
    ...
    document.getElementById("main").innerHTML = `<div id="intro">
            ...
            <p>Por ejemplo, en una IP como <code>192.168.1.10</code> con una máscara <code>255.255.255.0</code>, los primeros tres bloques (<code>192.168.1</code>) indican la red, y el último bloque (<code>.10</code>) representa el host.</p>
            <h3>Clases de IP</h3>
            <ul>
